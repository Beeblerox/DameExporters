...
DAME.AddHtmlTextLabel("Ensure you use the <b>SimpleClaws</b> PlayState.hx file in the samples as the original template for any code.")
DAME.AddBrowsePath("Haxe dir:","AS3Dir",false, "Where you place the Haxe files.")
...
DAME.AddTextInput("Game package", "com", "GamePackage", true, "package for your game's .hx files." )
